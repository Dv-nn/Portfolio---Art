...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[input="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[input="message"]');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    } else if (promocodeBlock.value === "IWANTPORART") {
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (eventName) {
    fileInputs.forEach(function (input) {
      input.addEventListener(eventName, prevenDefaults, false);
    });
  });
